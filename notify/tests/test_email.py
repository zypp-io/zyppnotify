...
def test_send_single_email():
    message = "This is a e-mail test using the MS Graph API"
    NotifyMail(
        to=f"{os.environ.get('TEST_EMAIL_1')}", subject="Test Notify single email (Graph)", message=message
    ).send_email()
    time.sleep(2)
...
def test_send_email_with_table():
    ...
    NotifyMail(
        ...
        subject="Test Notify with HTML table (Graph)",
        message=message,
        df=df,
    ).send_email()
    time.sleep(2)
...
def test_send_email_with_formatted_table():
    ...
    NotifyMail(
        to=f"{os.environ.get('TEST_EMAIL_1')}",
        subject="Test Notify with HTML table with formatted columns (Graph)",
        message=message,
        df=df,
    ).send_email()
    time.sleep(2)
...
def test_send_multiple_emails():
    ...
    NotifyMail(
        ...
        subject="Test Notify multiple emails (Graph)",
        message=message,
    ).send_email()
    time.sleep(2)
...
def test_send_file():
    message = "This is a e-mail test using the MS Graph API"
    subject = "Test Notify file (Graph)"
...
def test_send_file_from_storage():
    message = "This is a e-mail test using the MS Graph API"
    subject = "Test Notify file Azure Storage (Graph)"
    NotifyMail(
        to=f"{os.environ.get('TEST_EMAIL_1')}",
        subject=subject,
        message=message,
...
def test_send_cc():
    ...
    NotifyMail(
        ...
        subject="Test Notify cc emails (Graph)",
        message=message,
    ).send_email()
    time.sleep(2)
...
def test_send_bcc():
    ...
    NotifyMail(
        ...
        subject="Test Notify bcc emails (Graph)",
        message=message,
    ).send_email()
    time.sleep(2)
